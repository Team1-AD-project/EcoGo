...
class PointsServiceImplTest {
    ...
    void settleTrip_success() {
        ...
        // adjustPoints calls save once. The expired stats update logic (which called
        // save again) is removed.
        verify(userRepository, times(1)).save(mockUser);
    }

    // Removed settleTrip_userNotFound_duringStatsUpdate as the second fetch is
    // removed
